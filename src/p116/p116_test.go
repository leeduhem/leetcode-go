...
func TestConnect(t *testing.T) {
	in0 := &TreeLinkNode{ Val: 1, Left: &TreeLinkNode{ Val: 2, Left: &TreeLinkNode{ Val: 4 }, Right: &TreeLinkNode{ Val: 5 }},
		Right: &TreeLinkNode{ Val: 3, Left: &TreeLinkNode{ Val: 6 }, Right: &TreeLinkNode{ Val: 7 }}}
	...
	want0.Left.Right.Next = want0.Right.Left
	want0.Right.Left.Next = want0.Right.Right
